...
@Component({
  selector: 'app-plansummery-list',
  templateUrl: './plansummery-list.component.html',
  styleUrls: ['./plansummery-list.component.scss']
})
export class PlansummeryListComponent implements OnInit {
